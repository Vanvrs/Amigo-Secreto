let elemAmigo = document.getElementById("nome-amigo"); //input para adicionar nome do participante
let elemListaAmigos = document.getElementById("lista-amigos"); //Lista os amigos adicionado 
let elemListaSorteio = document.getElementById("lista-sorteio"); //Lista os amigos após sorteio
let amigos = [];
